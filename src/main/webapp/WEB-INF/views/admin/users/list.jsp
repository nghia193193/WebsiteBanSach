			...
			<div class="card">
				...
				<div class="card-body">
					...
					<c:if test="${!userPage.hasContent() }">
						<div class="row">
							<div class="col">
								<div class="alert alert-danger">Chưa có người dùng nào hãy thêm người dùng mới</div>
							</div>
						</div>
					</c:if>
										...
										<tr>
											...
											<td><c:if test="${user.avatar != null }">
													<img alt="" src="${user.avatar }" width="70px"
														class="img-fluid">
												</c:if> <c:if test="${user.avatar == null }">
													<img alt="" src="/templates/images/noimage.jpg"
								...
								<nav aria-label="Page navigation">
									<ul class="pagination">
										<li
											...
											<a class="page-link"
											href='<c:url value="/admin/users?size=${userPage.size}&page=${1}"/>'
										...
										<c:forEach items="${pageNumbers }" var="pageNumber">
											<c:if test="${userPage.totalPages > 1 }">
												<li
													...
													<a
													href='<c:url value="/admin/users?size=${userPage.size}&page=${pageNumber}"/>'
										...
										<li
											...
											<a
											href='<c:url value="/admin/users?size=${userPage.size}&page=${userPage.totalPages}"/>'
					...
					<div class="col-md-6">
							<div class="float-right">
								<a class="btn btn-outline-success" href="/admin/users/add">Add
									New User</a>
							</div>
						</div>
				</div>
